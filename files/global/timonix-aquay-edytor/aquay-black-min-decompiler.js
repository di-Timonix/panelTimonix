...
/*
	...
	ten plik służy do de-kompilowania kody zrozumiałego dla edytora aquay
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function decompiler_aquay_black_min(text) {
		...
		//var str = add_element_decompiler; 
		...
		add_button_media_obrazek.classList.add("aquay-open-modal");
		add_button_media_obrazek.setAttribute("id", "aquay_" + aquay_add_klucz);
		aquay_add_klucz++;
		add_button_media_obrazek.setAttribute("data-multiply", "false");
		...
		$("#decompiler_aquay_black_min").find(".aquay-obrazek").wrap('<div class="aquay-edytuj-container" data-blok-type="type_blok/obrazek"></div>').wrap('<div class="aquay-edytor-obrazek aquay-edytuj-obrazek" data-type="type/obrazek" tabindex="0"></div>').wrap('<div class="aquay-load-obrazek aquay-top-separator"></div>');	
		...
		add_button_media_galeria.classList.add("aquay-open-modal");
		add_button_media_galeria.setAttribute("id", "aquay_" + aquay_add_klucz);
		aquay_add_klucz++;
		add_button_media_galeria.setAttribute("data-multiply", "true");
		...
		$("#decompiler_aquay_black_min").find(".aquay-edytor-galeria").removeClass(".blackmin-galeria").wrapInner('<div class="aquay-load-galeria aquay-top-separator"></div>');
		...
		add_button_media_plik.classList.add("aquay-open-modal");
		add_button_media_plik.setAttribute("id", "aquay_" + aquay_add_klucz);
		aquay_add_klucz++;
		add_button_media_plik.setAttribute("data-multiply", "false");
		
		$("#decompiler_aquay_black_min").find(".blackmin-button-plik").addClass("aquay-load-plik aquay-top-separator aquay-edytuj-text aquay-input aquay-button-pobierz").attr("contenteditable", "true");
