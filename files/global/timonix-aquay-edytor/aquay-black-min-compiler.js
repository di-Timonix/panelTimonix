...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function compiler_aquay_black_min(text) {
		...
		$("#compiler_aquay_black_min").find(".blackmin-plik").find("button").addClass("blackmin-button-plik").removeClass("aquay-load-plik").removeClass("aquay-top-separator").removeClass("aquay-edytuj-text").removeClass("aquay-input aquay-button-pobierz").removeAttr("contenteditable").removeAttr("tabindex").removeAttr("tabindex");
